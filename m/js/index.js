(function($) {
	...
	function init(){
        ...
        $('.slot-txt').pictureani({ frameWidth: 228, frameHeight: 95, fps: 5, totalFrames: 6, loop:true });
    ...
    function setMove(){
        ...
        tl.from($('.main .slot-machine'), 1, {top:"+=300", autoAlpha:0});
    ...
    function renderAward(pData){
        var ele = ''
        + '<tr>'
        + '    <td style="width: 128px;">_date_</td>'
        + '    <td style="width: 112px;">_time_</td>'
        + '    <td style="width: 215px;">_gift_</td>'
        + '    <td style="width: 107px;">_sn_</td>'
        + '</tr>';
